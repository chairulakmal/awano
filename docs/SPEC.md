...
| 6   | ~~**Rate-limiting login:**~~ Resolved: in-process sliding-window counter (5 / 15 min) keyed on email, implemented in `loginAction`. Swap for Upstash Redis if horizontal scaling becomes relevant.                                                                                                                                                                                                                                                                                                                                                     | —     | —   |
